...
public class ProfileController {
    ...
    public ResponseEntity<CommonResponse<?>> createUserCareer(@RequestBody RequestCreateCareer request,
    ...
    public CommonResponse<?> getUserCareers(@PathVariable Long userid, @AuthenticationPrincipal UserDetails userDetails) {
        return CommonResponse.success("career 생성 성공", profileService.getCareers(userDetails));
    }

    @PutMapping("/users/{userid}/profile/career")
    public CommonResponse<?> updateUserCareers(@RequestBody RequestUpdateCareer request, @PathVariable Long userid, @AuthenticationPrincipal UserDetails userDetails) {
    ...
    public CommonResponse<?> deleteUserCareers(@PathVariable Long careerid, @PathVariable Long userid, @AuthenticationPrincipal UserDetails userDetails) {
